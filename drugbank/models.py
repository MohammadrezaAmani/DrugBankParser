...
class Synonym:
    def __init__(self, language, coder):
...
class Article:
    def __init__(self, refid, pubmedid, citation):
        self.refid = refid
...
class Textbook:
    def __init__(self, refid, isbn, citation):
        self.refid = refid
        self.isbn = isbn
        self.citation = citation
...
class Link:
    def __init__(self, refid, title, url):
        self.refid = refid
        self.title = title
        self.url = url
...
class References:
    ...
    def __init__(self, articles, textbooks, links, attachments):
...
class Internationalbrands:
    def __init__(self, internationalbrand):
...
class Mixture:
    def __init__(self, name, ingredients, supplementalingredients):
        self.name = name
...
class Price:
    ...
    def __init__(self, description, cost, currency):
        self.description = description
        self.cost = cost
...
class Category:
    def __init__(self, category, meshid):
        self.category = category
        self.meshid = meshid


class Affectedorganisms:
    def __init__(self, affectedorganism):
...
class Ahfscodes:
    def __init__(self, ahfscode):
        self.ahfscode = ahfscode


class Pdbentrys:
    def __init__(self, pdbentry):
...
class Patent:
    def __init__(self, number, country, approved, expires, pediatricextension):
        self.number = number
        self.country = country
        self.approved = approved
...
class Foodinteractions:
    def __init__(self, foodinteraction):
        self.foodinteraction = foodinteraction


class Druginteractions:
    def __init__(self, druginteraction):
        self.druginteraction = druginteraction


class Druginteraction:
    def __init__(self, drugbankid, name, description):
        self.drugbankid = drugbankid
        self.name = name
        self.description = description
...
class Sequences:
    def __init__(self, sequence, format):
...
class Calculatedproperty:
    def __init__(self, kind, value, source):
        self.kind = kind
        self.value = value
        self.source = source
...
class Externalidentifiers:
    def __init__(self, externalidentifier):
...
class Pathway:
    def __init__(self, smpdbid, name, category, drugs, enzymes):
...
class Pathwaydrug:
    def __init__(self, drugbankid, name):
        self.drugbankid = drugbankid
        self.name = name
...
class Reaction:
    def __init__(self, sequence, leftelement, rightelement, enzymes):
        self.sequence = sequence
...
class Reactionenzyme:
    def __init__(self, drugbankid, name, uniprotid):
        self.drugbankid = drugbankid
        self.name = name
        self.uniprotid = uniprotid
...
class Goclassifiers:
    def __init__(self, goclassifier):
